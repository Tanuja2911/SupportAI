    ...
    <div v-if="config" class="space-y-6">
      <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        <div>
          ...
          <input v-model="config.bot_name" class="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Welcome Message</label>
          <textarea v-model="config.welcome_message" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-indigo-500 resize-none"></textarea>
        </div>
        <div>
        ...
        <div>
          ...
          <input v-model="config.placeholder_text" class="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
